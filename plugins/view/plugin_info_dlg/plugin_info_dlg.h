...
#ifndef _PLUGIN_DLG_H
#define _PLUGIN_DLG_H
...
#define PLUGIN_NAME     "plugin-info-dlg"
#define PLUGIN_DESC     gettext_noop("a dialog showing the list of all loaded plugins")
