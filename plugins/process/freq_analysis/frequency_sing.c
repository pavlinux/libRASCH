 ...
 * frequency_sing.c
 *
 * Performs frequency calculations. For FFT, a C version of the Singelton algorithm is used.
 * See the header in fft_sing.c for more informations.
 *
