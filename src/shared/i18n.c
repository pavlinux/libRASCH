...
int do_i18n_conversion_inplace (char *string, size_t dest_size,
				const char *from, const char *to, int force);
int do_i18n_conversion (const char *src, char *dest, size_t dest_size,
			const char *from, const char *to, int force);
int local_is_utf8 ();
...
{
  return do_i18n_conversion (src, dest, dest_size, ra_i18n_codeset, "UTF-8",
			     0);
}				/* local_to_utf8() */
...
{
  return do_i18n_conversion_inplace (string, buf_size, ra_i18n_codeset,
				     "UTF-8", 0);
}				/* local_to_utf8_inplace() */


int
to_utf8 (const char *src, char *dest, size_t dest_size,
...
{
  return do_i18n_conversion_inplace (string, buf_size, src_encoding, "UTF-8",
				     1);
}				/* to_utf8_inplace() */
...
{
  return do_i18n_conversion (src, dest, dest_size, "UTF-8", ra_i18n_codeset,
			     0);
}				/* utf8_to_local() */
...
{
  return do_i18n_conversion_inplace (string, buf_size, "UTF-8",
				     ra_i18n_codeset, 0);
}				/* local_to_utf8_inplace() */


int
from_utf8 (const char *src, char *dest, size_t dest_size,
...
{
  return do_i18n_conversion_inplace (string, buf_size, "UTF-8", dest_encoding,
				     1);
}				/* from_utf8_inplace() */


int
do_i18n_conversion_inplace (char *string, size_t dest_size, const char *from,
...
int
do_i18n_conversion (const char *src, char *dest, size_t dest_size,
		    const char *from, const char *to, int force)
{
  int ret = 0;
  iconv_t cd;
