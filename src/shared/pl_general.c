...
int
fill_predef_class_info(long id, value_handle vh_id, value_handle vh_name, value_handle vh_desc)
{
...
int
fill_predef_class_info_ascii(const char *ascii_id, value_handle vh_name, value_handle vh_desc)
{
	int n_class = sizeof(ra_event_class) / sizeof(struct event_class_desc);
	int i, idx;
 ...
 */
int
fill_predef_prop_info(int prop, value_handle vh_id, value_handle vh_type, value_handle vh_len, value_handle vh_name,
		      value_handle vh_desc, value_handle vh_unit, value_handle vh_use_minmax, value_handle vh_min,
		      value_handle vh_max, value_handle vh_has_ign_val, value_handle vh_ign_val)
{
...
int
fill_predef_prop_info_ascii(const char *ascii_id, value_handle vh_type, value_handle vh_len,
			    ...
			    value_handle vh_has_ign_val, value_handle vh_ign_val)
{
	int n_prop = sizeof(ra_event_prop) / sizeof(struct event_prop_desc);
	int i, idx;
...
int
get_intersection_long(const long *v1, long num1, const long *v2, long num2, long **idx_v2_in_v1, long *num_idx)
{
	struct intersect_long *s1, *s2;
