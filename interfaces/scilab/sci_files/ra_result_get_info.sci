function [value, name, desc] = ra_result_get_info(plugin_handle, result_num, info_name)
...
//     desc
	...
	[value, name, desc] = ra_scilab('ra_result_get_info', plugin_handle, result_num, info_name);
